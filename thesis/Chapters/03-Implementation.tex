...
% TODO: justify not tracking rebuild times
...
\begin{figure}[htpb]
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Comparison between the \texttt{TimeBasedSimpleTrigger} and \texttt{TimeBasedAverageTrigger} strategies for $\lambda=1.5$ and $n=5$. A new tuning phase is initiated in both cases, however the \texttt{TimeBasedAverageTrigger} results in a higher threshold.}
