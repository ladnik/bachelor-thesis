	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:6,2) -- (axis cs:8.75,2) node[midway, yshift=2.5ex]{Tuning Phase};
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			...
			\begin{axis}[
				...
				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:12,2) -- (axis cs:15.75,2) node[midway, yshift=2.5ex]{Tuning Phase};
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			...
			\begin{axis}[
				...
				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:12,2) -- ([xshift=0.5*\barwidth]axis cs:23,2) node[midway, yshift=2.5ex]{Tuning Phase};
