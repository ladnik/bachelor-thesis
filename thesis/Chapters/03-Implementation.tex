...
AutoPas tracks a number of live simulation statistics. This thesis primarily focuses on runtimes of the current iteration, which include e.g. time spent computing interactions, tuning or rebuilding neighbor lists.
...
\tikzset{
	...
	accColorA/.style={draw=chapterdarkred},
	accColorB/.style={draw=violet},
	accColorC/.style={draw=ForestGreen},
}
\begin{figure}[htpb]
	\centering
	\def\barwidth{12pt}
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\draw[draw=tumblueaccverylight, customdash, dash phase=0.9] ([xshift=-0.5*\barwidth]5, 0.9*\lambdaval) -- ([xshift=0.5*\barwidth]5, 0.9*\lambdaval);

				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:6,2) -- (axis cs:8.75,2) node[midway, yshift=2.5ex]{new Tuning Phase};
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addlegendimage{legend image code/.code={
							\draw[fill=none, accColorA, thick, anchor=center] (0cm, 0cm) -- (0.3cm,0cm);
						}}
				\addlegendentry{\scriptsize$\phantom{\lambda}\text{avg}\left[t_{i-n}, t_{i-1}\right]$}

				\addlegendimage{legend image code/.code={
							\draw[fill=none, draw=chaptertumblue, customdash, thick, anchor=center] (0cm, 0cm) -- (0.3cm,0cm);
						}}
				...
				\draw[thick, accColorA] ([xshift=-0.5*\barwidth]axis cs: 0, 1.004) -- ([xshift=0.5*\barwidth]axis cs: 4, 1.004);
				...
				% avg is 1,004
				\draw[draw=tumblueaccverylight, customdash, dash phase=0.9] ([xshift=-0.5*\barwidth]5, 1.004*\lambdaval) -- ([xshift=0.5*\barwidth]5, 1.004*\lambdaval);
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			...
			\begin{axis}[
				...
				\addlegendentry{\scriptsize$t_k$}
				\addlegendimage{legend image code/.code={
							\draw[accColorA, thick] (0cm, 0cm)  -- (0.3cm,0cm);
						}}
				\addlegendentry{\scriptsize$\phantom{\lambda}\text{avg}(A)$}
				\addlegendimage{legend image code/.code={
							\draw[accColorB, thick] (0cm, 0cm)  -- (0.3cm,0cm);
						}}
				...
				\draw[thick, accColorA] ([xshift=-0.5*\barwidth]axis cs: 0, \avgA) -- ([xshift=0.5*\barwidth]axis cs: 5, \avgA);
				%				\node[accColorA, anchor=south west, align=left, inner sep=0pt, yshift=-0.125em] at ([xshift=-0.5*\barwidth]axis cs: 0, \avgA) {\scriptsize$\text{avg}(A)$};

				\draw[thick, accColorB] ([xshift=-0.5*\barwidth]axis cs: 6, \avgB) -- ([xshift=0.5*\barwidth]axis cs: 11, \avgB);
				...
				\draw[thick, customdash, chaptertumblue] ([xshift=-0.5*\barwidth]axis cs: 6, \avgA*\lambdaval) -- ([xshift=0.5*\barwidth]axis cs: 11, \avgA*\lambdaval);

				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:12,2) -- (axis cs:15.75,2) node[midway, yshift=2.5ex]{new Tuning Phase};
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			...
			\begin{axis}[
				...
				\addlegendimage{legend image code/.code={
							\draw[draw=chaptertumblue, thick, customdash, anchor=center] (0cm, 0cm)  -- (0.3cm,0cm);
						}}
				...
				\draw[accColorC, fill=ForestGreen!20, line join=round] ([xshift=-0.5*\barwidth]axis cs:12,1.08) -- ([xshift=0.5*\barwidth]axis cs: 23,1.98) -- ([xshift=0.5*\barwidth]axis cs: 23,1.08) -- cycle;
				\node[color=ForestGreen, align=center] at (axis cs: 19, 1.3) {\scriptsize$A_\triangle$};
				...
				\addplot[ybar, fill=tumblueaccverylight, draw=chaptertumblue, samples at={0,...,10}] {\yoff+\yscale/(1+exp(-\k*(x-\xzero)))};
				\addplot[ybar, fill=tumblueaccdark, draw=chaptertumblue, samples at={11}] {\yoff +\yscale/(1+exp(-\k*(x-\xzero)))};
				\addplot[ybar, fill=tumblueaccverylight, draw=chaptertumblue] coordinates {
				...
				\draw[thick, accColorA] ([xshift=-0.5*\barwidth]axis cs: 0, \avgA) -- ([xshift=0.5*\barwidth]axis cs: 11, \avgA);
				%				\node[chapterdarkred, anchor=south west, align=left, inner sep=0pt, yshift=-0.125em] at ([xshift=-0.5*\barwidth]axis cs: 0, \avgA) {\scriptsize$t_{\text{avg}}$};
				\draw[thick, accColorB] ([xshift=-0.5*\barwidth]axis cs: 12, 1.53) -- ([xshift=0.5*\barwidth]axis cs: 23, 1.53);
				%				\node[violet, anchor=south west, align=left, inner sep=0pt, yshift=-0.125em] at ([xshift=-0.5*\barwidth]axis cs: 12, 1.53) {\scriptsize$t_{\text{avg}}$ (proj.)};

				\draw[thick, customdash, chaptertumblue] ([xshift=-0.5*\barwidth]axis cs: 11, \avgA*\lambdaval) -- ([xshift=0.5*\barwidth]axis cs: 23, \avgA*\lambdaval);
				...
				\draw [decorate,decoration={brace, amplitude=1ex, raise=0.5ex}] ([xshift=-0.5*\barwidth]axis cs:12,2) -- ([xshift=0.5*\barwidth]axis cs:23,2) node[midway, yshift=2.5ex]{new Tuning Phase};
