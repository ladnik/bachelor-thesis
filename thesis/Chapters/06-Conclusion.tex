...
Especially in settings with low variance in iteration runtime, all strategies reduce the number of iterations spent in tuning phases without any significant decrease in optimality of the selected configurations. %TODO: check this
...
The other strategies investigated are more susceptible to the aforementioned fluctuations in the input data, but nonetheless outperform static tuning. % TODO: except simple trigger
